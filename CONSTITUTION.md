# CONSTITUTION — UI-Components-React

Project-specific governance for the **UI-Components-React** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
